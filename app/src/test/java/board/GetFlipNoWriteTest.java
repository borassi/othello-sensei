 ...
 * @author michele
 */
public class GetFlipNoWriteTest {
  ...
  public void testFlip() {
    ...
    for (long flip : possibleMoves) {
      ...
      long newFlip = GetFlipNoWrite.getFlip(move, board.getPlayer(), board.getOpponent());
      if (flip != newFlip) {
    ...
    assertEquals(0, GetFlipNoWrite.getFlip(0, board.getPlayer(), board.getOpponent()));
  }
...
//          newFlip = GetFlipNoWrite.getFlipLast(move, board.getOpponent());
//          newFlip = newFlip & ~board.getPlayer();
//        } else {
          newFlip = GetFlipNoWrite.getFlip(move, board.getPlayer(), board.getOpponent());          
//        }
        if (flip != newFlip) {
          System.out.println(board);
      ...
      for (int move = 0; move < movesFound.length; ++move) {
        if (!movesFound[move]) {
          if (GetFlipNoWrite.getFlip(move, board.getPlayer(), board.getOpponent()) != 0) {
            System.out.println(board);

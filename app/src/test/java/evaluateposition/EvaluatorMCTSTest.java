...
//    for (StoredBoard child : pos.eval.children) {
...
//            evaluator.firstPosition, evaluator.nextPositionEvalGoal());
//
//        if (nextPos == null) {
//          break;
//        }
//        StoredBoard next = nextPos.eval;
...
//          next.setUpper(eval);
//          next.setFree(100);
//        } else if (d <= 0.015 || nextPos.eval.lower > -6400 || nextPos.eval.upper < 6400) {
//          next.setSolved(eval);
//          next.setFree(100);
//        } else {
//          next.setFree(100);

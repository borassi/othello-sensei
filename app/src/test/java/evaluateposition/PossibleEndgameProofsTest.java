...
public class PossibleEndgameProofsTest {
  ...
  public void testOperations() {
    PossibleEndgameProofs c1 = new PossibleEndgameProofs(new StoredBoard(2, 1, true), 1);
    PossibleEndgameProofs c2 = new PossibleEndgameProofs(new StoredBoard(4, 1, true), 1);
    PossibleEndgameProofs c3 = new PossibleEndgameProofs(new StoredBoard(8, 1, true), 1);
    PossibleEndgameProofs c4 = new PossibleEndgameProofs(new StoredBoard(16, 1, true), 1);
  ...
  */
  ...
  public void testGetMinNumChildren() {
    for (int i = 0; i < 1000; ++i) {
      ...
      PossibleEndgameProofs g = new PossibleEndgameProofs(new StoredBoard(7, 0, true), n6);
      PossibleEndgameProofs c = new PossibleEndgameProofs(
          new StoredBoard(3, 0, true),
